  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <div className="grid min-h-dvh lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)]">
        ...
        <div className="relative flex flex-col bg-[radial-gradient(1200px_600px_at_0%_-10%,color-mix(in_oklab,var(--primary)_12%,transparent),transparent),radial-gradient(900px_500px_at_100%_100%,color-mix(in_oklab,#22c55e_10%,transparent),transparent)]">
