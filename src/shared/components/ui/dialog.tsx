  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          "fixed top-1/2 left-1/2 z-50 flex w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 flex-col gap-0 overflow-hidden rounded-xl border border-border/70 bg-background p-0 shadow-lg outline-none",
